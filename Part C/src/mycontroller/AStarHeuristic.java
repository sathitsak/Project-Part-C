 ...
 * 
 * @author Kevin Glass
 * Source: http://www.cokeandcode.com/info/showsrc/showsrc.php?src=../../pathfinder/PathFindingTutorial/target/src/org/newdawn/slick/util/pathfinding/AStarHeuristic.java
 */
public interface AStarHeuristic {
	 ...
	 */
	public float getCost(World world, Car car, int x, int y, int tx, int ty);
}